...
const Shop = () => {
    ...
    return (
        <>
            <div className='container mx-auto pt-[100px] md:pt-[150px]'>



                <div className='flex justify-center py-5 md:py-16'>
                    <div className='relative w-[380px] md:w-full h-[270px] md:h-[232px] lg:h-[232px] rounded-[20px] max-w-[1280px] overflow-hidden '>
                        <Image
                            src="/assets/si.jpeg"
                            layout="fill"
                            objectFit="cover"
                            alt="Market Place Hero Image"
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent"></div>
                        <div className='absolute bottom-[10%] left-[5%] md:left-[10%] z-50 max-w-[90%] md:max-w-[70%]'>
                            <p className='font-[600] text-[40px] md:text-[60px] lg:text-[80px] font-body text-white leading-tight'>
                                Market Place
                            </p>
                            <p className='text-white font-body font-[400] text-[14px] md:text-[16px] lg:text-[18px]'>
                                Increase cross-border sales with our e-commerce marketplace and arrowhead of African tech-driven industrialization.
                            </p>
                        </div>
                    </div>
                </div>
