        ...
        <div>
          <div className='container md:mx-[150px] flex flex-col md:flex-row lg:flex-row justify-start gap-2'>
            ...
            <div className='flex flex-col justify-end md:ml-7 lg:ml-7'>
              ...
              <div>
                <button className='bg-secondary-100 text-white w-[146px] h-[] md:h-[56px] md:w-[171px] rounded-[35px] flex justify-center items-center  space-x-2'><p>Start Now</p>
                  <FaArrowRight className='text-white text-[24px] ' />
                </button>
              </div>
            </div>
          </div>

          <div className='bg-black w-[268px] h-[214px]  md:h-[483px]md:w-[900px] lg:w-[1336px]  rounded-r-[32px] mt-4 '>
