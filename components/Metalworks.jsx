    ...
    return (
        <div className=' container mx-auto'>
            ...
            >
                ...
                <div className='flex flex-col md:flex-row w-[380px] h-[640px] md:w-[1261px] max-w-[1261px] justify-center mx-auto'>
                ...
                <div className='flex flex-col md:flex-row w-[380px] h-[628px] md:w-[1261px] max-w-[1261px] justify-center mx-auto'>
                    <div className='w-[340px] h-[340px] md:w-[524px] md:h-[524px]'>
                        <div className='relative w-full h-full'>
